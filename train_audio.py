...
sf.write("X_test.wav", X_test_ground_truth_audio, consts.SR)
...
for iter in range(num_iterations):
    ...
    sf.write("B_test_pred_"+str(iter)+".wav", B_pred_audio, consts.SR)
    sf.write("X_test_pred_"+str(iter)+".wav", X_pred_audio, consts.SR)
